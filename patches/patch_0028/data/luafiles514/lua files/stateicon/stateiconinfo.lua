...
StateIconList[EFST_IDs.EFST_STONE] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
...
StateIconList[EFST_IDs.EFST_FREEZE] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
...
StateIconList[EFST_IDs.EFST_STUN] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
...
StateIconList[EFST_IDs.EFST_SLEEP] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
...
StateIconList[EFST_IDs.EFST_POISON] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
...
StateIconList[EFST_IDs.EFST_CURSE] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
...
StateIconList[EFST_IDs.EFST_SILENCE] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
...
StateIconList[EFST_IDs.EFST_CONFUSION] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
...
StateIconList[EFST_IDs.EFST_BLIND] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
...
StateIconList[EFST_IDs.EFST_UNDEAD] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Turned Undead", COLOR_TITLE_BUFF}, 
		{"%s", COLOR_TIME}, 
		{"You become Undead property"}, 
		{"Support buffs such as Blessing and Increase AGI are removed"}
	}
}

StateIconList[EFST_IDs.EFST_DPOISON] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Deadly Poisoned", COLOR_TITLE_BUFF}, 
		{"%s", COLOR_TIME}, 
...
StateIconList[EFST_IDs.EFST_MOMENTUM] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Gaining Momentum", COLOR_TITLE_BUFF}, 
		{"%s", COLOR_TIME}, 
		{"Movement speed and Attack damage increased."}
	}
}

StateIconList[EFST_IDs.EFST_WEAKENED_SOUL] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Weakened Soul", COLOR_TITLE_BUFF}, 
		{"%s", COLOR_TIME}, 
		{"Taking extra damage from Soul Strike and Napalm Beat."}
	}
}

StateIconList[EFST_IDs.EFST_WHISTLE] = {
	haveTimeLimit = 1, posTimeLimitStr = 2, descript = {
		{"Melody", COLOR_TITLE_BUFF}, 
		{"%s", COLOR_TIME}, 
		{"Affected by magical melody."}
	}
}
